...
Revision ID: 94ae1c1ccdcc
Revises: 
Create Date: 2021-03-19 18:08:35.855295
...
def upgrade():
    ...
    op.create_table('user',
                    sa.Column('id', utils.GUID(), nullable=False),
    ...
    op.create_table('export_schemas',
                    sa.Column('id', utils.GUID(), nullable=False),
                    sa.Column('userId', utils.GUID(), nullable=True),
    ...
    op.create_table('form_jury_scientific_committee',
                    sa.Column('id', utils.GUID(), nullable=False),
                    sa.Column('memberId', utils.GUID(), nullable=True),
                    sa.Column('type', sa.String(length=64), nullable=False),
    ...
    op.create_table('form_event_organization_members',
                    sa.Column('member_id', utils.GUID(), nullable=False),
                    sa.Column('form_id', utils.GUID(), nullable=False),
    ...
    op.create_table('form_supervision_supervisors',
                    sa.Column('supervisor_id', utils.GUID(), nullable=False),
                    sa.Column('form_id', utils.GUID(), nullable=False),
